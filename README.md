...
🛠 Tech Stack
LayerTechFrameworkReact 18 + TypeScriptBuild toolViteStylingTailwind CSS + CSS custom propertiesComponentsshadcn/ui (Radix UI primitives)Data fetchingTanStack React Query v5ChartsRechartsRoutingReact Router v6BackendExpress.js (Node)IconsLucide React
🚀 Getting Started
bash# Frontend
cd helpdesk-ui
npm install
npm run dev
bash# Backend (optional — app falls back to mock data without it)
