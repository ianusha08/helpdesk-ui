import { Bold, Italic, Underline, Image, Paperclip, Link2, Quote, Code, ArrowRight, Send } from "lucide-react";
    ...
    <div className="border border-border rounded-lg bg-card">
      ...
      {activeTab === "public" && (
        <div className="px-4 py-2 border-b border-border flex items-center gap-2">
          ...
          <div className="inline-flex items-center gap-1.5 bg-muted rounded-full pl-1 pr-3 py-1 text-sm">
            <UserAvatar initials="AW" size="sm" />
            <span className="text-xs">Allison Westervelt &lt;awestervelt@email.com&gt;</span>
      ...
      <div className="flex items-center justify-between px-3 py-2 border-t border-gray-100">
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="p-2 bg-brand text-primary-foreground rounded-md hover:bg-brand-hover transition-colors">
